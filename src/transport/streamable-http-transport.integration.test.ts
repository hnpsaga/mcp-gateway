...
describe('Discovery integration with StreamableHttpTransport', () => {
  ...
  async function createConnectedEnvironment() {
    ...
    const transport = new StreamableHttpTransport(connectionRegistry);
  ...
  it('should discover tools from an HTTP MCP server', async () => {
  ...
  it('should discover resources from an HTTP MCP server', async () => {
    const env = await createConnectedEnvironment();
  ...
  it('should discover prompts from an HTTP MCP server', async () => {
    const env = await createConnectedEnvironment();
...
describe('Execution integration with StreamableHttpTransport', () => {
  let mockServer: MockHttpMcpServer;
