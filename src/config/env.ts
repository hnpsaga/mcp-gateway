...
const parsed = configSchema.safeParse({
  ...
  TRANSPORT_LOG_LEVEL: process.env.TRANSPORT_LOG_LEVEL,
  TRANSPORT_MAX_MESSAGE_SIZE: process.env.TRANSPORT_MAX_MESSAGE_SIZE,
  TRANSPORT_STDOUT_BUFFER_SIZE: process.env.TRANSPORT_STDOUT_BUFFER_SIZE,
  TRANSPORT_STDERR_BUFFER_SIZE: process.env.TRANSPORT_STDERR_BUFFER_SIZE,
  TRANSPORT_MAX_CONCURRENT_REQUESTS: process.env.TRANSPORT_MAX_CONCURRENT_REQUESTS,
  TRANSPORT_PROCESS_STARTUP_TIMEOUT: process.env.TRANSPORT_PROCESS_STARTUP_TIMEOUT,
  TRANSPORT_INITIALIZE_TIMEOUT: process.env.TRANSPORT_INITIALIZE_TIMEOUT,
  TRANSPORT_CONNECTION_TIMEOUT: process.env.TRANSPORT_CONNECTION_TIMEOUT,
  TRANSPORT_DISCONNECT_TIMEOUT: process.env.TRANSPORT_DISCONNECT_TIMEOUT,
